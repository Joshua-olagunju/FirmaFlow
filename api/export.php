...
// Check subscription access (export features only available for Enterprise plan)
...
if ($plan !== 'enterprise') {
    ...
    if ($plan === 'free') {
        echo json_encode(['error' => 'Export feature requires an Enterprise subscription plan. Please upgrade to access data export functionality.']);
    } else {
        echo json_encode(['error' => 'Export feature is only available for Enterprise subscribers. Please upgrade to Enterprise to access data export functionality.']);
    }
    exit;
}
