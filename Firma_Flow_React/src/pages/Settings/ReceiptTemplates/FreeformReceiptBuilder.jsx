...
const FreeformReceiptBuilder = ({ onClose, onSave }) => {
  ...
  const elementTypes = [
    ...
    { type: "receiptDetails", label: "Receipt #, Date, Time", icon: Type },
    { type: "itemsList", label: "Items List", icon: Table },
    { type: "totals", label: "Totals", icon: DollarSign },
    { type: "paymentMethod", label: "Payment Method", icon: CreditCard },
  ...
  const renderElement = (element) => {
    ...
    switch (element.type) {
      case "header":
        return (
          <div style={style}>
            <h2 style={{ color: customColor, margin: 0 }}>RECEIPT</h2>
          </div>
        );
      case "companyInfo":
        return (
      ...
      case "receiptDetails":
        return (
          <div style={style} className="text-xs space-y-1">
            <p>
              <span className="font-semibold">Receipt #:</span> RCP-001
            </p>
            <p>
        ...
        return (
          <div style={style} className="text-xs space-y-1">
            ...
            <div className="flex justify-between font-bold border-t pt-1">
              ...
              <span style={{ color: customColor }}>₦53,750</span>
            </div>
          </div>
        );
      case "paymentMethod":
        return (
          <div style={style} className="text-xs space-y-1">
            <p>
              <span className="font-semibold">Payment:</span> Cash
            </p>
            <p>
              <span className="font-semibold">Amount Paid:</span> ₦60,000
            </p>
            <p>
              <span className="font-semibold">Change:</span> ₦6,250
            </p>
          </div>
        );
      case "text":
              ...
              {elements.length === 0 && (
                <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                  <div className="text-center">
                    ...
                    <p className="text-sm">
                      All elements removed. Add elements from the toolbar.
                    </p>
                  </div>
                </div>
              )}
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-[60]">
          ...
          >
            ...
            <p className={`${theme.textSecondary} mb-1`}>
              Your freeform receipt template has been saved.
            </p>
...
export default FreeformReceiptBuilder;
