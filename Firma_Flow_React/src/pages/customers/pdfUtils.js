 ...
 * @param {Array} invoices - Invoice history data
 * @param {Array} payments - Payment history data
 * @param {Object} stats - Customer statistics (totalSpending, totalPayments, balance, creditLimit)
 */
export const exportToPDF = (customer, invoices, payments, stats) => {
  ...
  const htmlContent = `
    ...
    <body>
      ...
      <div class="customer-info">
        ...
        <p><strong>Type:</strong> ${customer.customerType || "N/A"}</p>
        <p><strong>Payment Terms:</strong> ${customer.paymentTerms || "N/A"}</p>
          ...
          <tbody>
            ...
            ${
              invoices.length > 0
                ? `
              <tr class="total-row">
                <td colspan="3">Invoice Totals</td>
                <td>₦${invoices
 ...
 */
export const printPDF = (customer, invoices, payments, stats) => {
