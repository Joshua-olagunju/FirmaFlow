        ...
        <div className="absolute top-full mt-2 right-0 bg-white border border-slate-300 rounded-lg p-4 shadow-xl z-40 min-w-[320px]">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full px-4 py-2 text-sm bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white rounded-lg hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Apply Date Range
            </button>
          </div>
